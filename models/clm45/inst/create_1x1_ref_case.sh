...
CROOT=/fs/data5/pecan.models/CLM_dev_tags/ref_cases/CLM460_tkg2017/

DIN_LOC_ROOT=/fs/data5/pecan.models/CLM_dev_tags/cesminputdata
DOMAIN_PATH=${DIN_LOC_ROOT}/share/domains/

WORKDIR=`pwd`

# XMLCHANGE=/fs/data5/pecan.models/CLM_dev_tags/clm4_6_00/scripts/ccsm_utils/Tools
...
rm -rf ${CASEROOT}
./create_newcase -case ${CASEROOT} -res 1x1_brazil -compset ${COMP} -mach ubuntu -compiler gnu
...
##${XMLCHANGE}/xmlchange -file env_run.xml -id DATM_CO2_TSERIES -val rcp4.5
##${XMLCHANGE}/xmlchange -file env_run.xml -id CLM_CO2_TYPE -val 'diagnostic'
...
#${XMLCHANGE}/xmlchange -file env_run.xml -id DOUT_S_SAVE_INTERIM_RESTART_FILES -val TRUE
